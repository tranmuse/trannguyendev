        ...
        <>
            <div className="w-full h-full">
                <div className="flex flex-no-wrap">
                    {/* Sidebar starts */}
                    <div className="w-64 absolute lg:relative bg-white shadow h-screen flex-col justify-between hidden lg:flex pb-8">
                        <div className="px-8">
                                ...
                                <ul className="mt-4">
                                    <li className="flex w-full justify-between text-indigo-700 cursor-pointer items-center mb-6">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm pl-2">Kanban Board</span>
                                        </div>
                                    ...
                                    <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mb-6">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm pl-2">Bookmarks</span>
                                        </div>
                                    ...
                                    <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mb-6">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm pl-2">Calendar</span>
                                        </div>
                                    </li>
                                </ul>

                        </div>
                        <div className="px-8 border-t border-gray-300 text-gray-400 text-sm pt-2">
                            <p>2021 Tran Nguyen.</p>
                                    ...
                                    <div className="px-8">
                                        <ul className="mt-12">
                                            <li className="flex w-full justify-between text-indigo-700 cursor-pointer items-center mb-6">
                                                <div className="flex items-center">
                                                    <FontAwesomeIcon icon="check-square" />
                                                    <span className="xl:text-base md:text-2xl text-base ml-2 pl-2">Kanban Board</span>
                                                </div>
                                                <div className="py-1 px-3 bg-indigo-700 rounded text-white flex items-center justify-center text-xs">5</div>
                                            </li>
                                            <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mb-6">
                    ...
                    <div className="w-full bg-gray-200">
                        {/* Navigation starts */}
                        <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative visible lg:hidden z-0">
